...
OcppOperation *makeOcppOperation(WebSocketsClient *ws, const char *messageType) {
  ...
  if (!strcmp(messageType, "Authorize")) {
    ...
    if (onReserveNowSendConf == NULL)
      Serial.print(F("[SimpleOcppOperationFactory] Warning: ReserveNow is without effect when the sendConf listener is not set. Set a listener which ReserveNow your device.\n"));
    ...
    if (onCancelReservationSendConf == NULL)
      Serial.print(F("[SimpleOcppOperationFactory] Warning: CancelReservation is without effect when the sendConf listener is not set. Set a listener which CancelReservation your device.\n"));
  ...
  */
  ...
  /**/
    ...
    if (onClearCacheSendConf == NULL)
      Serial.print(F("[SimpleOcppOperationFactory] Warning: ClearCache is without effect when the sendConf listener is not set. Set a listener which sends ClearCache.\n"));
