#line 1 "D:\\AmplifyMobility\\Test COde\\Code- AC001-Shobha demo\\AC001_Three_Connectors\\src\\libraries\\arduinoWebSockets-master\\src\\WebSockets.h"
/**
 * @file WebSockets.h
 * @date 20.05.2015
...
#include"OCPP_ETH_WIFI.h"   //added for Ethernet config
#ifdef STM32_DEVICE
...
#elif defined(ESP32)
#define WEBSOCKETS_NETWORK_TYPE NETWORK_ESP32  //@mwh
...
#if ETHERNET_ACTIVE   //custom by wamique for Ethernet
#define WEBSOCKETS_NETWORK_TYPE NETWORK_W5100
#endif
